...
// Function to convert the spectrum value to the corresponding degrees; 666 = junction
int directionController(int spectrum) {
  ...
  const int degreeValues[]   = {10, 2, 20, -2, -10, -20, 666};   // Corresponding degree values
